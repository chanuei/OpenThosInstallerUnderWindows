...
// OpenThosInstaller.cpp : 定义应用程序的类行为。
//
...
BEGIN_MESSAGE_MAP(COpenThosInstallerApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// COpenThosInstallerApp 构造

COpenThosInstallerApp::COpenThosInstallerApp()
{
	// 支持重新启动管理器
...
// 唯一的一个 COpenThosInstallerApp 对象

COpenThosInstallerApp theApp;


// COpenThosInstallerApp 初始化

BOOL COpenThosInstallerApp::InitInstance()
{
